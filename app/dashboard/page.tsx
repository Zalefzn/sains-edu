    ...
    () =>
      locale === "id"
        ? {
          ...
          choosePathTitle: "Mulai dari mana?",
          choosePathSubtitle:
            "Pilih jalur rekomendasi atau langsung masuk ke peta modul.",
          pathRecommended: "Jalur rekomendasi",
          pathRecommendedDesc:
            "Mulai dari pre-test diagnostik, lihat skor dan profil awal, lalu dapatkan rekomendasi jalur dasar, sedang, atau lanjut.",
          pathExplore: "Eksplor bebas",
          pathExploreDesc:
            "Lewati pre-test dan langsung masuk ke peta modul atau menu utama untuk memilih materi secara mandiri.",
          openPath: "Mulai",
        ...
        : {
          ...
          choosePathSubtitle:
            "Choose the recommended route or go straight to the module map.",
          pathRecommended: "Recommended route",
          pathRecommendedDesc:
            "Start with a diagnostic pre-test, review your score and initial profile, then receive a basic, intermediate, or advanced path suggestion.",
          pathExplore: "Free exploration",
          pathExploreDesc:
            "Skip the pre-test and go directly to the module map or main menu for self-directed study.",
          openPath: "Start",
          alertTitle: "Notice",
          alertOk: "OK",
